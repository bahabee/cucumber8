...
public class SecureSmartOrderPage {

    public SecureSmartOrderPage(WebDriver driver){
    ...
    public void clickProcessButtonAndValidateMessage(String expectedMessage){
        processButton.click();
        Assert.assertEquals(expectedMessage,BrowserUtils.getText(message));
    }


    public void validateAllInformation (String customerName, String product, String quantity,
                                            String date, String street, String city, String state,
